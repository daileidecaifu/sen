...
public class SwitchButton extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mStrokeRadius = typedArray.getDimension(R.styleable.SwitchButton_strokeRadius, dp2px(STROKE_RADIUS));
        mStrokeWidth = typedArray.getDimension(R.styleable.SwitchButton_strokeWidth, dp2px(STROKE_WIDTH));
        mTextSize = typedArray.getDimension(R.styleable.SwitchButton_textSize, sp2px(TEXT_SIZE));
        mSelectedColor = typedArray.getColor(R.styleable.SwitchButton_selectedColor, SELECTED_COLOR);
        mUnSelectedColor = typedArray.getColor(R.styleable.SwitchButton_unSelectedColor, SELECTED_COLOR);
    ...
    private void initPaint() {
        ...
        mSelectedTextPaint.setColor(mUnSelectedColor);
        mStrokePaint.setAntiAlias(true);
     ...
     * @return
     */
    public SwitchButton setText(@NonNull List<String> list) {
        if (list.size() > 1) {
