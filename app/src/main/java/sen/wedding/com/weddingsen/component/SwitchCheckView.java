...
public class SwitchCheckView extends View{
    ...
    public SwitchCheckView(Context context) {
        this(context, null);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public SwitchCheckView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setLayerType(LAYER_TYPE_SOFTWARE, null);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SwitchCheckView);
        colorPrimary = a.getColor(R.styleable.SwitchCheckView_primaryColor, DEFAULT_COLOR_PRIMARY);
        colorPrimaryDark = a.getColor(R.styleable.SwitchCheckView_primaryColorDark, DEFAULT_COLOR_PRIMARY_DARK);
        hasShadow = a.getBoolean(R.styleable.SwitchCheckView_hasShadow, true);
        isOpened = a.getBoolean(R.styleable.SwitchCheckView_isOpened, false);
    ...
    public interface OnStateChangedListener {
        void toggleToOn(SwitchCheckView view);

        void toggleToOff(SwitchCheckView view);
    }

    private OnStateChangedListener listener = new OnStateChangedListener() {
        @Override
        public void toggleToOn(SwitchCheckView view) {
            toggleSwitch(true);
        }

        @Override
        public void toggleToOff(SwitchCheckView view) {
            toggleSwitch(false);
        }
    };
